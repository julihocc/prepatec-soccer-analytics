...
print(f"\nINTERPRETACIÓN:")
print(f"Veterano: {es_veterano} - {'Experiencia valiosa' if es_veterano else 'Jugador joven'}")
print(f"En forma: {en_forma} - {'Buen momento' if en_forma else 'Puede mejorar'}")
print(f"Titular: {es_titular} - {'Jugador clave' if es_titular else 'Necesita más minutos'}")
```
