...
datos_partidos['Gana_Local'] = (datos_partidos['Ganador'] == datos_partidos['Equipo_Local']).astype(int)
...
datos_prueba['Gana_Local_Real'] = (datos_prueba['Ganador_Real'] == datos_prueba['Equipo_Local']).astype(int)
